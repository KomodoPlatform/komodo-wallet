...
class NftMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isInitial = context.select<NftMainBloc, bool>(
    ...
    final List<NftBlockchains> tabs = context
        .select<NftMainBloc, List<NftBlockchains>>(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(color: colorScheme.surfContHighest),
            ),
          ),
        ...
        Flexible(
          child: Builder(
            builder: (context) {
              final mode = context.select<AuthBloc, AuthorizeMode>(
              ...
              final BaseError? error = context.select<NftMainBloc, BaseError?>(
                (bloc) => bloc.state.error,
              );
              if (error != null) {
