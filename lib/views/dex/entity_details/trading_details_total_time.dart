...
class _TradingDetailsTotalTimeState extends State<TradingDetailsTotalTime> {
  ...
  String _totalSpentTime() {
    ...
    if (date.hour == 0) {
      return LocaleKeys.tradingDetailsTotalSpentTime.tr(
        args: [date.minute.toString(), date.second.toString()],
      );
    }
    return LocaleKeys.tradingDetailsTotalSpentTimeWithHours.tr(
      args: [
        date.hour.toString(),
