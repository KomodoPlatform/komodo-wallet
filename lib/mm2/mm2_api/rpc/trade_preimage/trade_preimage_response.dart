...
class TradePreimageResponseResult {
  ...
  factory TradePreimageResponseResult.fromJson(
    Map<String, dynamic> json,
  ) => TradePreimageResponseResult(
    baseCoinFee: TradePreimageExtendedFeeInfo.fromJson(json['base_coin_fee']),
    ...
    feeToSendTakerFee: json['fee_to_send_taker_fee'] != null
        ? TradePreimageExtendedFeeInfo.fromJson(json['fee_to_send_taker_fee'])
        : null,
