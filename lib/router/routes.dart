...
class StakingRoutePath implements AppRoutePath {
  StakingRoutePath.staking()
    : location = '/${firstUriSegment.staking}',
      assetId = '';
  StakingRoutePath.asset(this.assetId)
    : location = '/${firstUriSegment.staking}/${assetId.toLowerCase()}';
